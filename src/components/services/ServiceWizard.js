                ...
                <div className="grid gap-3">
                    ...
                    {applyAcl && (
                        <div className="mm-glass rounded-xl p-3 border border-white/10">
                            ...
                            {/*{aclResult && (*/}
                            {/*    <div className="mt-3 mm-glass rounded-xl p-3">*/}
                            {/*        <div className="font-semibold mb-1 text-green-300">ACL applied</div>*/}
                            {/*        <div className="text-sm">Redis user: <code className="font-mono">{aclResult.username}</code></div>*/}
                            {/*        <div className="text-sm">*/}
                            {/*            Password (copy now): <code className="font-mono">{aclResult.secret}</code>*/}
                            {/*        </div>*/}
                            {/*        <div className="mt-1 text-xs opacity-70">Keep this secret safe — it will not be shown again.</div>*/}
                            {/*    </div>*/}
                            {/*)}*/}
                            {aclResult && (
